...
from todo.views.task_operations import add_view, detail_view, delete_task_view, edit_task_view, confirm_delete_task_view
...
urlpatterns = [
    ...
    path('tasks/deleted/<int:pk>', confirm_delete_task_view, name='confirm_delete')
]